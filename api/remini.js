...
(async () => {
  ...
  // Remini
  const IMAGE = "https://i.pinimg.com/736x/4e/e0/c3/4ee0c3cd39a2c53041e0fa95570abb70.jpg";
  const SETTINGS = {
    face_enhance: {
      model: "remini"
    },
  ...
  // Contoh menghapus Watermark
  // const remove = await Remove("https://www.lukecollinsphotography.com/wp-content/uploads/2018/10/should-you-watermark-images-5.jpg");
